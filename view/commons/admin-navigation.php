        ...
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <div id="userManagementSubMenu" class="collapse">
                    <ul class="list-group">
                        <li class="list-group-item"><a href="http://localhost/BcsKSM/view/module/modules/user-management/user.php">Users</a></li>
                    </ul>
                </div>
            </li>
            <li class="list-group-item">
                ...
                <div id="menuManagementSubMenu" class="collapse">
                    <ul class="list-group">
                        <li class="list-group-item"><a href="http://localhost/BcsKSM/view/module/modules/menu-management/categories.php">Categories</a></li>
                        <li class="list-group-item"><a href="http://localhost/BcsKSM/view/module/modules/menu-management/items.php">Items</a></li>
            ...
            <li class="list-group-item">
                ...
                <div id="ingredientsManagementSubMenu" class="collapse">
                    <ul class="list-group">
                        <li class="list-group-item"><a href="http://localhost/BcsKSM/view/module/modules/ingredients-management/ingredients.php">Ingredients</a></li>
                        <li class="list-group-item"><a href="http://localhost/BcsKSM/view/module/modules/ingredients-management/stock.php">Stock</a></li>
                    </ul>
                </div>
            </li>
            <li class="list-group-item">
            ...
            <li class="list-group-item">
                <a href="http://localhost/BcsKSM/view/module/modules/orders/orders.php">Orders</a>
            </li>
            <li class="list-group-item">
                <a href="http://localhost/BcsKSM/view/module/modules/dashboard/dashboard.php">Dashboard</a>
            </li>
            <li class="list-group-item">
                <a href="http://localhost/BcsKSM/view/module/modules/cashier/cashier.php">Cashier</a>
            </li>
        </ul>
    </div>
</div>

            ...
            <div class="accordion">
                <div class="row">
                    <form class="form-inline">
                        <input class="form-control " id="seachBar" type="search" placeholder="Search" onkeyup="search()" aria-label="Search">
                    ...
                    <ul class="list-group">
                        ...
                        while($foodrow = $fooditemResult->fetch_assoc()){
                            ...
                            ?>
                            <a type="button" class="list-group-item items" href="edit-foodItems.php?status=edit-foodItem&foodId=<?php echo $foodid ?>">
                        ...
                        while($otherItemRow = $otherItemResult->fetch_assoc())
                        {
                            ...
                            ?>
                            <a type="button" class="list-group-item items" href="edit-otherItems.php?status=edit-Item&itemId=<?php echo $otherItemId ?>">

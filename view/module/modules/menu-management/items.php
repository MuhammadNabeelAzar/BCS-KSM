...
<?php 
    ...
    <div class="row">
        ...
        <div class="col" style="background-color:yellow">
            <div class="row">
                <button type="button" class="col btn btn-primary" onclick="switchToAddOtherItemBtn()">Other
                    Item</button>
                ...
                <form id="add-item-form" action="../../../../controller/menu_controller.php?status=add-fooditem"
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" id="food_descript"

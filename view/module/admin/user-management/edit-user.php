...
<body>
    ...
    <div class="container">
                    ...
                    <form action="../../../../controller/user_controller.php?status=edit-user"
                      ...
                      <?php
                        ...
                        <div class="col">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="firstName" name="users_fname" value="<?php echo $userrow['Fname'] ?>">
                            </div>                           
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="L-name">Last Name</span>
                                </div>
                                <input type="text" class="form-control" id="lastName" name="users_lname" value="<?php echo $userrow['Lname'] ?>">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="Email">Email</span>
                                </div>
                                <input type="text" class="form-control" id="user_Email" name="users_email" value="<?php echo $userrow['user_email'] ?>">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="Unic">NIC</span>
                                </div>
                                <input type="text" class="form-control" id="user_Nic" name="users_nic" value="<?php echo $userrow['user_nic'] ?>">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="Contact">Contact Number</span>
                                </div>
                                <input type="text" class="form-control" id="user_Contact" name="users_cno" value="<?php echo $userrow['user_contactNo'] ?>" >
                            </div>
                        </div>
                        ...
                        <div class=" d-flex flex-column">
                            ...
                            <option value="">----</option>
                                        ...
                                        {
                                            ?>
                                            <option name="user_role" value="<?php echo $rolerow["role_id"]; ?>"  
                                                 <?php
                                                 if($userrow["role_id"]==$rolerow["role_id"])
                                                 {
                                                   ...
                                                   ?>
                                                    > <?php echo $rolerow["role_name"]; ?> </option>
                                            <?php
                                        }
                                        ?>
                            </select>
